		...
		<VStack shadow="2xl" h="100%" w="100%" bg="brand.accent.500" rounded="3xl">
			...
			<VStack h="100%" alignItems="flex-start" w="100%" px="5">
					...
					<>
						<HStack py="2" color="white">
							...
							<VStack alignItems="flex-start" gap="0">
								<Heading fontSize={{ base: 'xl', md: 'xl' ,xl: '3xl' }}>{airport.oaciCode + " | " + airport.iataCode}</Heading>
								<Text fontSize={{ base: 12, md: 'sm', xl: 16 }} fontWeight="bold">{"OACI | IATA"}</Text>
							</VStack>
						</HStack>
				...
				<HStack py="2" color="white">
					...
					<Heading fontSize={{ base: 'xl', md: 'xl', xl: '3xl' }}>{airport.region}</Heading>
				</HStack>
				...
				<HStack py="2" color="white">
					...
					<VStack alignItems="flex-start" gap="0">
						<Heading fontSize={{ base: 'xl', md: 'xl', xl: '3xl' }}>{airport.fir.code}</Heading>
						<Text  fontSize={{ base: 12, md: 'sm', xl: 16 }} fontWeight="bold">{airport.fir.name}</Text>
					</VStack>
				</HStack>
				...
				<HStack py="2" color="white">
					...
					<VStack alignItems="flex-start" gap="0">
						<Heading fontSize={{ base: 'xl', md: 'xl', xl: '3xl' }}>{Math.trunc(airport.elevation * 3.281) + "Ft"}</Heading>
						<Text fontSize={{ base: 12, md: 'sm', xl: 16 }} fontWeight="bold">{Math.trunc(airport.elevation) + "Mts"}</Text>
					</VStack>
				</HStack>
				...
				<HStack py="2" color="white">
					...
					<VStack alignItems="flex-start" gap="0">
						<Heading fontSize={{ base: 'xl', md: 'xl', xl: '3xl' }}>{airport.public ? "Público " : "Privado "}</Heading>
						<Text fontSize={{ base: 12, md: 'sm', xl: 16 }} fontWeight="bold">{airport.controlled ? "Controlado" : "No controlado"}</Text>
					</VStack>
				</HStack>
				...
				<HStack py="2" color="white">
					...
					<VStack gap="0" alignItems="flex-start">
						<Heading fontSize={{ base: 'xl', md: 'xl', xl: '3xl' }}>{airport.geometry.coordinates.lat.toFixed(2) + "," + airport.geometry.coordinates.lng.toFixed(2)}</Heading>
						<Text fontSize={{ base: 12, md: 'sm', xl: 16 }} fontWeight="bold">{airport.coordinates[0] + " , " + airport.coordinates[1]} </Text>
					</VStack>
				</HStack>
